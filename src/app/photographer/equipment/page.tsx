...
function Page() {
  return (
    <>
      ...
      <EquipmentAccordion
        name="Nikon D7100"
        description="My first 'serious' camera, bought second hand in 2018 and one I still use to
...
"
      ...
      <EquipmentAccordion
        name="Praktica MTL5B"
        description="An East German SLR produced from 1985-1989. I purchased in reasonably good
...
clunk when fired."
      ...
      <EquipmentAccordion
        ...
        description="A medium format camera with a folding lens, produced from 1949 to 1957. 
...
but great fun to use once you understand its quirks."
      ...
      <EquipmentAccordion
        name="Nikkor 18-55mm"
        description="This came as the kit lens with my Nikon D7100. It's an unremarkable but
...
snapshots."
      ...
      <EquipmentAccordion
        ...
        description="This was the first additional lens I bought after getting the D7100. 
...
since picking up the Beroflex."
      ...
      <EquipmentAccordion
        ...
        description="This might not be the sharpest, fastest, or most modern lens around, but if
...
both."
      ...
      <EquipmentAccordion
        ...
        description="This lens was bought as a set with my Praktica MTL5B. It's very possibly
...
give lovely shallow focus."
      ...
      <EquipmentAccordion
        ...
        description="A Soviet-built lens purchased second-hand in late 2025 for use with my 
...
M42 adaptor ring very firmly attached."
      ...
      <EquipmentAccordion
        ...
        description="This is a selenium light-meter from the 1950s. It's a beautiful object to look
...
and I find it works very well despite its age."
      ...
      <EquipmentAccordion
        ...
        description="The tricky thing about using my Nettar is getting the focus right. You focus it
